...
| 13   | 判断是不是完全二叉树                 | [leetcode_958](https://leetcode.com/problems/check-completeness-of-a-binary-tree/) | BEGIN LOOP<br />curNode := queue[0]  queue = queue[1:] <br />if curNode == nil { isPreviousNull = true }<br />else { if isPreviousNull { return false } <br />APPEND curNode Left and Right<br />END LOOP<br />return true |
