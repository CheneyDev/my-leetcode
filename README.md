...
| 12   | 判断是不是二叉搜索树                 | [leetcode_98](https://leetcode.com/problems/validate-binary-search-tree/) | <code>这里是<br />你的代码root.Left = right<br/>	root.Right = left<br/><br/>	invert(root.Left)<br/>	invert(root.Right)</code> |
| 13   | 判断是不是完全二叉树                 | [leetcode_958](https://leetcode.com/problems/check-completeness-of-a-binary-tree/) |                                                              |
| 14   | 判断是不是平衡二叉树                 | [leetcode_110](https://leetcode.com/problems/balanced-binary-tree/) |                                                              |
| 15   | 二叉搜索树的最近公共祖先             | [leetcode_235](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree/) |                                                              |
| 16   | 在二叉树中找到两个节点的最近公共祖先 | [leetcode_236](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-tree/) |                                                              |
